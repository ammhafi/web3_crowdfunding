    ...
    <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
      ...
      <div className='flex flex-col p-4'>
        ...
        <div className='block'>
          ...
          <p className='mt-[5px] font-epilogue font-[12px] text-[#808191] text-left leading-[18px] truncate'>{description}</p>
        </div>
        ...
        <div className='flex items-center mt-[20px] gap-[12px]'>
          ...
          <p className='flex-1 font-normal font-epilogue text-[12px] text-[#808191] truncate'>by {owner} <span className='text-[#b2b2bd]'>{owner}</span></p>
        </div>
      </div>
    </div>
  )
